  ...
  return (
    <div className="cuan-surface" style={{ marginTop: 48, padding: '20px 24px', display: 'flex', flexDirection: 'column', gap: 16 }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
        ...
        <button onClick={handleCopyLink} className="cuan-btn cuan-btn-secondary" style={{ padding: '8px 10px' }} aria-label="Copy link" title="Copy link">
          <LinkIcon />
        </button>
        <button onClick={shareOnX} className="cuan-btn cuan-btn-secondary" style={{ padding: '8px 10px' }} aria-label="Share on X" title="Share on X">
          <XIcon />
        </button>
        <button onClick={shareOnFacebook} className="cuan-btn cuan-btn-secondary" style={{ padding: '8px 10px' }} aria-label="Share on Facebook" title="Share on Facebook">
          <FacebookIcon />
        </button>
        <button onClick={shareOnLinkedIn} className="cuan-btn cuan-btn-secondary" style={{ padding: '8px 10px' }} aria-label="Share on LinkedIn" title="Share on LinkedIn">
          <LinkedInIcon />
        </button>
      </div>
